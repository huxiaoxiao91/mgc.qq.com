package model.data
{
	...
	public class SurpriseTreasurePaneVo extends EventDispatcher
	{
		...
		private var _updateBg:Boolean = false;
		...
		public function get updateBg():Boolean
		{
			return _updateBg;
		}

		public function set updateBg(value:Boolean):void
		{
			_updateBg = value;
			dispatchEvent(new Event("updateBg"));
		}
