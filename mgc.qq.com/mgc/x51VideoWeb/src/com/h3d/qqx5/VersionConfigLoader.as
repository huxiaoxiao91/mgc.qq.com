	...
	public class VersionConfigLoader
	{
		...
		public function loadConfig(callback:Function, path:String = ""):void
		{
			...
			try
			{
				if (path == null || path == "")
				{
					loader.load(new URLRequest(Globals.SwfFolderURL + DEFAULT_CONFIG_URL));
				}
				else
				{
					loader.load(new URLRequest(Globals.SwfFolderURL + path));
				}
			...
			{
				callbackFun = null;
				Globals.s_logger.error("read version_config.xml faile");
			}
		}
