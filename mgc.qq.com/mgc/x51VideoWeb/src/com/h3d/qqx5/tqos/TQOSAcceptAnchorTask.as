package com.h3d.qqx5.tqos
{
	...
	public class TQOSAcceptAnchorTask
	{
		public function TQOSAcceptAnchorTask()
		{
		...
		{
			Globals.s_logger.tqos(nType+"@"+nRoomId+"@"+strClientIP+"@"+nDeviceType+"@"+nErrorCode+"@"+strErrorMsg);
		}
	}
}