...
require(['mgc_callcenter', 'mgc_comm_view', 'mgc_show_coll', 'mgc_show_view', 'main_entry', 'mgc_tool', 'mgc_ranklist'], function(callcenter, comm_view, show_coll, show_view, entry, tool, ranklist) {
    var loginCallback = function(res_type, resp, params) {
        console.log("login callback");
        //榜单NAV
        initRankNavTab();
    };
    var initRankNavTab = function() {
        ...
        new show_view.TabNavView('#rc_tab', tab_coll, 1, ranklist.InitRanks.Init);
    };
    //周星榜
    callcenter.query_weekstar_ranklist("", 0, 10, ranklist.getWeekstarArr);
    //假数据
    // ranklist.getWeekstarArr({"groups": [], "res": 3});
