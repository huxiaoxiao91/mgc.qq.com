...
require(['main_entry', 'mgc_callcenter', 'mgc_transfer', 'mgc_tool', 'mgc_dialog'], function (entry, callcenter, transfer, tool, mgc_dialog) {
    var loginCallback = function (res_type, resp, params) {
        console.log("login callback");
        var roomid = tool.roomid();
        callcenter.check_room_status(roomid, transfer.checkRoomStatusCallBack);
    };
