/**
 * Created by Hu Xiaoxiao on 2017/01/10.
 */
//debugger 环境下，开发用的配置
...
require(['mgc_callcenter', 'jsrender', 'mgc_comm_view', 'mgc_ad', 'main_entry', 'mgc_tool', 'mgc_playback'], function(callcenter, jsrender, comm_view, ad, entry, tool, playback) {
    var loginCallback = function(res_type, resp, params) {
        console.log("login callback");
    };
    // 获取演唱会回放房间列表事件 341
    callcenter.concert_playback_room_get_roomlist(0, 30, playback.concertPlaybackRoomGetRoomlistRes);
