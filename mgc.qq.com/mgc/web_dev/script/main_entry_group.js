...
require(['mgc_callcenter', 'mgc_comm_view', 'mgc_index', 'mgc_ad', 'main_entry', 'mgc_group_model', 'mgc_group_view'], function(callcenter, comm_view, index, ad, entry, group_model, group_view) {
    var loginCallback = function (res_type, resp, params) {
        group_view.init();
    };
    callcenter.listenToInited(entry.onNetworkInited(loginCallback));
});
