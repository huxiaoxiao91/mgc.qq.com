...
showDialog = (function() {
    ...
    return {
        show: function(p, typeNum) {
            var a = (typeof (p) === 'object') ? p : {}, b;
            this.id = a.id || null;
            this.bgcolor = a.bgcolor || '#111';
            this.opacity = a.opacity || 0;//update by 77
            this.src = a.src || null;
        ...
        popupInit: function() {
            ...
            if (b != null && gEl(b)) {
                ...
                if (!!this.delayPop) {
                    ...
                    if (this.typeNum) {
                        window.mgc.popmanager.layerControlShow($m("#" + this.id), 5, 1);
                    }
                    else {
                        window.mgc.popmanager.layerControlShow($m("#" + this.id), 4, 1, true);
                    }
                }
                setStyle(h, {
                    visibility: 'visible',
        ...
        hide: function(p) {
            document.getElementById("CommonDialog").style.display = "";
            ...
            window.mgc.popmanager.layerControlHide($m("#" + this.id), 4, 1, true);
            return
        },
        overlay: function() {
            var a = getMaxH(),
