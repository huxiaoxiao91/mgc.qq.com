...
require(['mgc_callcenter', 'jsrender', 'room_entry', 'mgc_room_ad','mgc_hotbox', 'mgc_chat'], function(callCenter, jsrender, entry, room_ad,mgc_hotbox, $chat) {
    
    /**
     * 粉丝区广告
     */
    var adModel = new room_ad.ADModel({ type: 1 });
    var adView = new room_ad.ADView({ model: adModel, el: ".layer-fans .ad" });
    mgc.adModel = adModel;
    mgc.adView = adView;
    ...
    rewardTipView.top2 = 55;
    mgc.rewardTipModel = rewardTipModel;

    /**
     * 开启宝箱ip
     */
    var tmplData = [{boxid:13,left:85},{boxid:14,left:120},{boxid:15,left:160},{boxid:16,left:200}];
