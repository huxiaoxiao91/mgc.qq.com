...
require(['mgc_callcenter', 'mgc_comm_view', 'mgc_ad', 'main_entry', 'mgc_tool', 'mgc_show'], function(callcenter, comm_view, ad, entry, tool, show) {
    var loginCallback = function(res_type, resp, params) {
        console.log("login callback");
        //load room list
        callcenter.query_custom_tab_list(false, show.getCustomTabListCallBack);
    };
    //轮播banner广告
    window.adMessageCon = {};
