...
require(['mgc_callcenter', 'jsrender', 'room_entry', 'mgc_tool', 'mgc_caveolaeroom', 'mgc_luckydraw', 'mgc_room_ad', 'mgc_hotbox', 'mgc_secret_order', 'mgc_anchor_pk', 'mgc_pkrank', 'mgc_chat', 'mgc_festival_activity', 'mgc_last_king'], function(callCenter, jsrender, entry, tool, mgc_caveolaeroom, mgc_luckydraw, room_ad, mgc_hotbox, mgc_secret_order, anchor_pk, mgc_pkrank, $chat, mgc_festival_activity, mgc_last_king) {
     ...
     * 密令按钮 
     */
    var secretOrderData = new mgc_secret_order.secretOrderModel();
