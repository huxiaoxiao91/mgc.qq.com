...
require(['jquery', 'jqtmpl', 'mgc_callcenter', 'mgc_comm_view', 'main_entry', 'mgc_tool', 'jq_dialog'], function($, jqtmpl, callcenter, comm_view, entry, tool, jq_dialog) {
    var loginCallback = function(res_type, resp, params) {
        console.log("login callback");
        //执行登录回调
        if (window.mgc.loginCallback)
            window.mgc.loginCallback();
    };
