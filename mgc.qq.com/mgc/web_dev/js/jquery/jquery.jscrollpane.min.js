        ...
        function d(D, O) {
            ...
            function ar(aQ) {
                ...
                if (Y === c) {
                    ...
                    if (ay.maintainPosition && !aJ && L == T && Y.outerHeight() == Z) {
                        D.width(aj);
                        return
                    }
                    L = T;
                ...
                Z = Y[0].scrollHeight;//获取div.jspPane的高度
                Y.css("overflow", "");
                y = T / aj;
                q = Z / v;
                az = q > 1;
            ...
            function aF() {
                if (az) {
                    //al.html(al.html() + '<div class="jspVerticalBar"><div class="jspCap jspCapTop"></div><div class="jspTrack"><div class="jspDrag"><div class="jspDragTop"></div><div class="jspDragBottom"></div></div></div><div class="jspCap jspCapBottom"></div></div>');
                    ...
                    var jspVerticalBar = document.createElement("div");
                    jspVerticalBar.className = "jspVerticalBar";
                    jspVerticalBar.innerHTML = '<div class="jspCap jspCapTop"></div><div class="jspTrack"><div class="jspDrag"><div class="jspDragTop"></div><div class="jspDragBottom"></div></div></div><div class="jspCap jspCapBottom"></div>';
                    al.append(jspVerticalBar);
                    ...
                    au.hover(function() {
                        ...
                        b("html").bind("mousemove.jsp", function(aJ) {
                            V(aJ.pageY - s, false);
                            // 拖动滚动条时，清除缓存的数据
                            if (ay.mousemoveCallback) {
                                ay.mousemoveCallback();
                            }
            ...
            function z() {
                if (aE) {
                    //al.html(al.html() + '<div class="jspHorizontalBar"><div class="jspCap jspCapLeft"></div><div class="jspTrack"><div class="jspDrag"><div class="jspDragLeft"></div><div class="jspDragRight"></div></div></div><div class="jspCap jspCapRight"></div></div>');
                    ...
                    var jspVerticalBar = document.createElement("div");
                    jspVerticalBar.className = "jspHorizontalBar";
                    jspVerticalBar.innerHTML = '<div class="jspCap jspCapLeft"></div><div class="jspTrack"><div class="jspDrag"><div class="jspDragLeft"></div><div class="jspDragRight"></div></div></div><div class="jspCap jspCapRight"></div>';
                    al.append(jspVerticalBar);
            ...
            b.extend(Q, {
                initScroll: function(isBottom) {
                    ...
                    if(!isBottom)
                    {
                        //au.css("top", 0);
                        //ad(0);
                        D.find('.jspPane').css("top",0);
                        D.find('.jspDrag').css("top",0);
                    }
                },
