...
package org.bytearray.gif.player {
	...
	public class GIFPlayer extends Bitmap {
		...
		private var needCacheDecoder:Boolean;

		public function GIFPlayer(pAutoPlay:Boolean = true, needCacheDecoder:Boolean = false) {
			auto = pAutoPlay;
			iIndex = iInc = 0;
			this.needCacheDecoder = needCacheDecoder;
...
//			gifDecoder = new GIFDecoder();
		...
		*/
		 ...
		 *
		 */
		public function readDecoder(decoder:GIFDecoder):void {
			aFrames = new Array();
			iInc = 0;
			gifDecoder = decoder;
			initFrames();
		...
		public function getGifDecoderToSave():Object {
			return {url: gifURL, decoder: gifDecoder};
		}
